...
<body>
                    ...
                    @foreach ($type as $key => $value)
                        <div class="col-lg-3">
                            <div class="categories__item set-bg"
                                data-setbg="../../Avatar/2022_02_15_02_43_25_202989192_784058459144311_1458422114325030121_n.jpg">
    ...
    <section class="featured spad">
        <div class="container">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                            <div class="featured__item">
                                <div class="featured__item__pic set-bg"
                                    data-setbg="../../Avatar/{{ $value->productImage[0]->link_image ?? '' }}">
            ...
            <div class="row featured__filter" style="display: flex; justify-content: flex-end; padding: 0px 20px;">
                {{ $data['product']->links() }}
            </div>
        </div>
    </section>
